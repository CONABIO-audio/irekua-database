...
def copy_annotators_into_new_models(apps, schema_editor):
    ...
    Annotator = apps.get_model('selia_annotator', 'Annotator')
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('annotator', models.ForeignKey(db_column='annotation_tool_id', help_text='Annotation tool', on_delete=django.db.models.deletion.CASCADE, to='selia_annotator.annotator', verbose_name='annotation tool')),
            ],
            options={
