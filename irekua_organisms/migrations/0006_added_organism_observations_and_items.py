...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        (
            "irekua_organisms",
            "0005_added_restriction_option_to_organism_config",
        ),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                ...
                default=True,
                help_text=(
                    "Flag indicating whether types of organism "
                    "observation are restricted to registered ones"
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                default=None,
                help_text="Deployed device that capture this organism",
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                ...
                default=True,
                help_text=(
                    "Flag indicating whether any type of item "
                    "can be associated to captures of this type"
                ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                help_text=(
                    "Types of items that can be associated "
                    "to organism of this type."
                ),
                to="irekua_items.ItemType",
                verbose_name="item types",
            ),
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                ...
                default=True,
                help_text=(
                    "Flag indicating whether any type of item can "
                    "be associated to organisms of this type"
                ),
                verbose_name="restrict item types",
            ),
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        help_text=(
                            "Flag indicating whether any type of item "
                            "can be associated to observations of this type"
                        ),
                        verbose_name="restrict item types",
                    ),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        help_text=(
                            "Sampling event types on which this "
                            "types of observation are made"
                        ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text=(
                            "Valid term types to describe the "
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        ...
                        db_column="metadata",
                        help_text=(
                            "Additional metadata associated to "
                            "organism observation"
                        ),
                        null=True,
                ...
                (
                    ...
                    models.JSONField(
                        ...
                        help_text=(
                            "Additional metadata associated to "
                            "organism observation in collection"
                        ),
                        null=True,
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        help_text=(
                            "Sampling event in which the organism was observed"
                        ),
                        on_delete=django.db.models.deletion.PROTECT,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        db_column="metadata_schema_id",
                        help_text=(
                            "JSON Schema for collection-specific metadata"
                        ),
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="collectiontypeorganismobservationtype_metadata_schema",  # noqa
                        to="irekua_schemas.schema",
                        verbose_name="metadata schema",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        db_column="organism_observation_type_id",
                        help_text=(
                            "Organism observation type to be "
                            "registered to the collection type"
                        ),
                        on_delete=django.db.models.deletion.PROTECT,
                        to="irekua_organisms.organismobservationtype",
                        verbose_name="organism observation type",
            ...
            options={
                ...
                "verbose_name_plural": (
                    "Collection Type Organism Observation Types"
                ),
                "ordering": ["-created_on"],
                "unique_together": {
                    (
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                help_text=(
                    "Types of organism observation that can be "
                    "registered into collections of this type."
                ),
                through="irekua_organisms.CollectionTypeOrganismObservationType",  # noqa
                to="irekua_organisms.OrganismObservationType",
