            ...
            state_operations=[
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('metadata_schema', models.JSONField(blank=True, db_column='metadata_schema', default=irekua_database.utils.simple_JSON_schema, help_text='JSON Schema for metadata of device info', validators=[irekua_database.utils.validate_JSON_schema], verbose_name='metadata schema')),
                        ('configuration_schema', models.JSONField(blank=True, db_column='configuration_schema', default=irekua_database.utils.simple_JSON_schema, help_text='JSON Schema for configuration info of device', validators=[irekua_database.utils.validate_JSON_schema], verbose_name='configuration schema')),
                        ('brand', models.ForeignKey(db_column='device_brand_id', help_text='Brand of device', on_delete=django.db.models.deletion.PROTECT, related_name='device_brand', to='irekua_devices.devicebrand', verbose_name='brand')),
                        ('device_type', models.ForeignKey(db_column='device_type_id', help_text='Type of device', on_delete=django.db.models.deletion.PROTECT, related_name='device_type', to='irekua_types.devicetype', verbose_name='device type')),
                    ],
                    options={
                        'verbose_name': 'Device',
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('metadata', models.JSONField(blank=True, db_column='metadata', default=irekua_database.utils.empty_JSON, help_text='Metadata associated to device', null=True, verbose_name='metadata')),
                        ...
                        ('device', models.ForeignKey(db_column='device_id', help_text='Brand and model of device', on_delete=django.db.models.deletion.PROTECT, to='irekua_devices.device', verbose_name='device')),
