...
# from irekua_database.admin.types import TagAdmin
...
# admin.site.register(models.Tag, types.TagAdmin)
...
# admin.site.register(models.DeploymentType, types.DeploymentTypeAdmin)
