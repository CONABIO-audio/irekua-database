...
from irekua_models.admin.model_runs import ModelRunAdmin


admin.site.register(models.Model, ModelAdmin)
admin.site.register(models.ModelVersion, ModelVersionAdmin)
admin.site.register(models.ModelPrediction, ModelPredictionAdmin)
