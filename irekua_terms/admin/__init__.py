...
from .synonym_suggestion import SynonymSuggestionAdmin
from .term_suggestions import TermSuggestionAdmin
from .entailment_type import EntailmentTypeAdmin
from .entailment import EntailmentAdmin
from .term_type import TermTypeAdmin
from .synonym import SynonymAdmin
from .term import TermAdmin


admin.site.register(models.SynonymSuggestion, SynonymSuggestionAdmin)
admin.site.register(models.TermSuggestion, TermSuggestionAdmin)
