...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('irekua_visualizers', '0001_initial'),
        ...
        migrations.SeparateDatabaseAndState(
            state_operations=[
                ...
                migrations.AlterField(
                    ...
                    name='visualizer',
                    field=models.OneToOneField(db_column='visualizer_id', help_text='Visualizer', on_delete=django.db.models.deletion.CASCADE, to='irekua_visualizers.visualizer', verbose_name='visualizer'),
                ),
                migrations.AlterField(
                ...
                migrations.AlterField(
                    model_name='visualizercomponent',
                    name='item_types',
                    field=models.ManyToManyField(through='irekua_visualizers.VisualizerComponentItemType', to='irekua_types.ItemType'),
                ),
            ],
            database_operations=[],
        ),
