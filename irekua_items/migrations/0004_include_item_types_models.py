            ...
            state_operations=[
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('annotation_types', models.ManyToManyField(blank=True, help_text='Valid annotation types for this event type', to='irekua_items.AnnotationType', verbose_name='annotation types')),
                ...
                migrations.AlterField(
                    ...
                    name='annotation',
                    field=models.JSONField(blank=True, db_column='annotation', help_text='Information of annotation location within item', verbose_name='annotation'),
                ),
                migrations.AlterField(
                    model_name='item',
                    name='media_info',
                    field=models.JSONField(blank=True, db_column='media_info', help_text='Information of resource file', verbose_name='media info'),
                ),
                migrations.AlterField(
                    model_name='item',
                    name='metadata',
                    field=models.JSONField(blank=True, db_column='metadata', help_text='Metadata associated to item', null=True, verbose_name='metadata'),
                ),
                migrations.AlterField(
                    model_name='licence',
                    name='metadata',
                    field=models.JSONField(blank=True, db_column='metadata', help_text='Metadata associated with licence', null=True, verbose_name='metadata'),
                ),
                migrations.AlterField(
                    model_name='secondaryitem',
                    name='media_info',
                    field=models.JSONField(blank=True, db_column='media_info', help_text='Media information of secondary item file', null=True, verbose_name='media info'),
                ),
                migrations.CreateModel(
                    name='LicenceType',
                    fields=[
                        ...
                        ('metadata_schema', models.ForeignKey(blank=True, db_column='metadata_schema_id', help_text='JSON Schema for additional metadata', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='licencetype_metadata_schema', to='irekua_schemas.schema', verbose_name='metadata schema')),
                    ],
                    options={
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('event_types', models.ManyToManyField(blank=True, db_column='event_types', help_text='Types of event for this item type', to='irekua_items.EventType', verbose_name='event types')),
                        ('metadata_schema', models.ForeignKey(blank=True, db_column='metadata_schema_id', help_text='JSON Schema for additional metadata', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='itemtype_metadata_schema', to='irekua_schemas.schema', verbose_name='metadata schema')),
                        ('mime_types', models.ManyToManyField(blank=True, db_column='mime_types', help_text='Mime types of files for this item type', to='irekua_types.MimeType', verbose_name='mime types')),
                    ],
                    options={
                ...
                migrations.AlterField(
                    ...
                    field=models.ForeignKey(db_column='annotation_type_id', help_text='Type of annotation', on_delete=django.db.models.deletion.PROTECT, to='irekua_items.annotationtype', verbose_name='annotation type'),
                ),
                migrations.AlterField(
                    model_name='annotation',
                    name='event_type',
                    field=models.ForeignKey(db_column='event_type_id', help_text='Type of event being annotated', on_delete=django.db.models.deletion.PROTECT, to='irekua_items.eventtype', verbose_name='event type'),
                ),
                migrations.AlterField(
                    model_name='item',
                    name='item_type',
                    field=models.ForeignKey(db_column='item_type_id', help_text='Type of resource', on_delete=django.db.models.deletion.PROTECT, to='irekua_items.itemtype', verbose_name='item type'),
                ),
                migrations.AlterField(
                    model_name='item',
                    name='ready_event_types',
                    field=models.ManyToManyField(blank=True, help_text='Types of event for which item has been fully annotated', to='irekua_items.EventType', verbose_name='ready event types'),
                ),
                migrations.AlterField(
                    model_name='licence',
                    name='licence_type',
                    field=models.ForeignKey(db_column='licence_type_id', help_text='Type of licence used', on_delete=django.db.models.deletion.PROTECT, to='irekua_items.licencetype', verbose_name='licence type'),
                ),
                migrations.AlterField(
                    model_name='secondaryitem',
                    name='item_type',
                    field=models.ForeignKey(db_column='item_type', help_text='Type of file of secondary item', on_delete=django.db.models.deletion.PROTECT, to='irekua_items.itemtype', verbose_name='item type'),
                ),
            ],
            database_operations=[],
        )
