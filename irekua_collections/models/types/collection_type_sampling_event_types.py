...
class CollectionTypeSamplingEventType(
    ...
    collection_type = models.ForeignKey(
        ...
        help_text=_(
            "Collection type in which this sampling event type is permitted"
        ),
        blank=False,
        null=False,
    )
    ...
    sampling_event_type = models.ForeignKey(
        ...
        help_text=_(
            "Sampling Event type to be admissible in collections of this type"
        ),
        blank=False,
        null=False,
    )
    ...
    class Meta:
        ...
        unique_together = (("collection_type", "sampling_event_type"),)

    def __str__(self):
        msg = _(
            "Collection %(collection)s: Sampling Event Type %(sampling_event)s"
        )
        params = dict(
