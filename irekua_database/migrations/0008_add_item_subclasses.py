...
def move_deployment_references_and_thumbnails(apps, schema_editor):
    ...
    for item in Item.objects.all():
        ...
        collection_item = CollectionItem(item_ptr=item, collection=collection)
        collection_item.__dict__.update(item.__dict__)
        collection_item.save()

        sampling_event_item = SamplingEventItem(
            collectionitem_ptr=collection_item, sampling_event=sampling_event
        )
        ...
        if thumbnail:
            item_thumbnail = ItemThumbnail(item=item, thumbnail=thumbnail)
            item_thumbnail.save()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("irekua_database", "0007_create_collection_licence"),
    ]
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        primary_key=False,
                        serialize=False,
                        to="irekua_database.collectionitem",
                    ),
                ),
                (
                    "sampling_event",
                    models.ForeignKey(
                        ...
                        help_text=(
                            "Sampling event in which this item was captured"
                        ),
                        on_delete=django.db.models.deletion.PROTECT,
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        primary_key=False,
                        serialize=False,
                        to="irekua_database.samplingeventitem",
                    ),
                ),
                (
                    "deployment_tmp",
                    models.ForeignKey(
                        ...
                        help_text=(
                            "Deployment of device in which this item "
                            "was captured"
                        ),
                        on_delete=django.db.models.deletion.PROTECT,
