...
def get_item_path(instance, filename):
    ...
    hash_string = irekua_database.utils.hash_file(instance.item_file)
...
def get_secondary_item_path(instance, filename):
    path_fmt = os.path.join(
        "secondary_items",
        "{collection}",
        "{sampling_event}",
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        default=False,
                        help_text="Flag to indicate if user is a model developer",
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        default=False,
                        help_text="Flag to indicate if user is a curator",
                        verbose_name="is curator",
                    ),
                ),
                (
                    "is_model",
                    models.BooleanField(
                        db_column="is_model",
                        default=False,
                        help_text="Flag to indicate if user is an AI model",
                        verbose_name="is model",
                    ),
                ),
                (
                    "groups",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        db_column="description",
                        help_text="Description of collection",
                        verbose_name="description",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        db_column="logo",
                        help_text="Logo of data collection",
                        null=True,
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        db_column="is_open",
                        default=False,
                        help_text="Boolean flag indicating whether contents of the collection are public.",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="Administrators of collection",
            ...
            options={
                ...
                "ordering": ["-created_on"],
                "permissions": (
                    ("add_collection_site", "Can add site to collection"),
                    ("add_collection_item", "Can add item to collection"),
                    ("add_collection_device", "Can add device to collection"),
                    (
                        "add_collection_sampling_event",
                        "Can add a sampling event to collection",
                    ),
                    ("add_collection_user", "Can add user to collection"),
                    (
                        "add_collection_licence",
                        "Can add licence to collection",
                    ),
                    (
                        "add_collection_annotation",
                        "Can annotate items in collection",
                    ),
                    (
                        "add_collection_annotation_vote",
                        "Can vote on annotations of items in collection",
                    ),
                    ("view_collection_sites", "Can view sites in collection"),
                    ("view_collection_items", "Can view items in collection"),
                    (
                        "view_collection_devices",
                        "Can view devices in collection",
                    ),
                    (
                        "view_collection_sampling_events",
                        "Can view sampling event in collection",
                    ),
                    (
                        "view_collection_annotations",
                        "Can view annotations of items in collection",
                    ),
                    (
                        "change_collection_sites",
                        "Can change sites in collection",
                    ),
                    (
                        "change_collection_users",
                        "Can change user info in collection",
                    ),
                    (
                        "change_collection_items",
                        "Can change items in collection",
                    ),
                    (
                        "change_collection_devices",
                        "Can change devices in collection",
                    ),
                    (
                        "change_collection_annotations",
                        "Can change annotations of items in collection",
                    ),
                    (
                        "change_collection_sampling_events",
                        "Can change sampling events in collection",
                    ),
                    (
                        "download_collection_items",
                        "Can download annotation items",
                    ),
                ),
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="ID of device within the collection (visible to all collection users)",
                        max_length=64,
                        verbose_name="ID within collection",
                    ),
                ),
                (
                    "metadata",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        help_text="Collection to which the device belongs",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="collectiondevice_created_by",
                        to=settings.AUTH_USER_MODEL,
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="collectiondevice_modified_by",
                        to=settings.AUTH_USER_MODEL,
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        ...
                        default=irekua_database.utils.simple_JSON_schema,
                        help_text="JSON Schema for metadata of collection device info",
                        validators=[
                            irekua_database.utils.validate_JSON_schema
                        ],
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        ...
                        db_column="metadata_schema",
                        default=irekua_database.utils.simple_JSON_schema,
                        help_text="JSON Schema for metadata of collection item info",
                        validators=[
                            irekua_database.utils.validate_JSON_schema
                        ],
                        verbose_name="metadata schema",
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        ...
                        db_column="metadata_schema",
                        default=irekua_database.utils.simple_JSON_schema,
                        help_text="JSON Schema for metadata of collection role info",
                        validators=[
                            irekua_database.utils.validate_JSON_schema
                        ],
                        verbose_name="metadata schema",
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        ...
                        db_column="metadata",
                        default=irekua_database.utils.empty_JSON,
                        help_text="Metadata associated to site in collection",
                        null=True,
                        verbose_name="metadata",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        db_column="internal_id",
                        help_text="ID of site within the collection (visible to all collection users)",
                        max_length=64,
                        verbose_name="ID within collection",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        db_column="collection_id",
                        help_text="Collection to which the site belongs",
                        on_delete=django.db.models.deletion.CASCADE,
                        to="irekua_database.Collection",
                        verbose_name="collection",
                    ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="collectionsite_created_by",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="creator",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="collectionsite_modified_by",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="modified by",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_column="name",
                        help_text="Name for device type",
                        max_length=64,
                        unique=True,
                        verbose_name="name",
                    ),
                ...
                (
                    ...
                    models.TextField(
                        db_column="description",
                        help_text="Description of device type",
                        verbose_name="description",
                    ),
                ),
                (
                    ...
                    models.ImageField(
                        blank=True,
                        db_column="icon",
                        help_text="Icon for device type",
                        null=True,
            ...
            fields=[
                ...
                (
                    ...
                    sorl.thumbnail.fields.ImageField(
                        ...
                        help_text="Thumbnail associated to file",
                        null=True,
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        ...
                        db_column="metadata_schema",
                        default=irekua_database.utils.simple_JSON_schema,
                        help_text="JSON Schema for metadata of licence info",
                        validators=[
                            irekua_database.utils.validate_JSON_schema
                        ],
                        verbose_name="metadata schema",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_part_of",
                    models.ManyToManyField(
                        blank=True, to="irekua_database.Locality"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        ...
                        db_column="metadata_schema",
                        default=irekua_database.utils.simple_JSON_schema,
                        help_text="JSON Schema for metadata of localities of this type",
                        null=True,
                        validators=[
                            irekua_database.utils.validate_JSON_schema
                        ],
                        verbose_name="metadata_schema",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="MIME types associated with item type",
                        max_length=128,
                        unique=True,
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        db_column="commentaries",
                        help_text="Sampling event commentaries",
                        verbose_name="commentaries",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        help_text="Date at which sampling begun",
                        null=True,
                ...
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        db_column="ended_on",
                        help_text="Date at which sampling stoped",
                        null=True,
                ...
                (
                    ...
                    models.ForeignKey(
                        db_column="collection_id",
                        help_text="Collection to which sampling event belongs",
                        on_delete=django.db.models.deletion.PROTECT,
                        to="irekua_database.Collection",
                        verbose_name="collection",
                    ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        to="irekua_database.CollectionSite",
                        verbose_name="collection site",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="samplingevent_created_by",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="creator",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        help_text="Licence for all items in sampling event",
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="samplingevent_modified_by",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="modified by",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_column="name",
                        help_text="Name fo sampling event type",
                        max_length=128,
                        unique=True,
                        verbose_name="name",
                    ),
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        db_column="description",
                        help_text="Description of sampling event type",
                        verbose_name="description",
                    ),
                ),
                (
                    ...
                    models.ImageField(
                        blank=True,
                        db_column="icon",
                        help_text="Icon for sampling event type",
                        null=True,
                ...
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        ...
                        db_column="metadata_schema",
                        default=irekua_database.utils.simple_JSON_schema,
                        help_text="JSON Schema for metadata of sampling event info",
                        validators=[
                            irekua_database.utils.validate_JSON_schema
                        ],
                        verbose_name="metadata schema",
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        default=False,
                        help_text="Flag indicating whether to restrict device types associated with this sampling event type",
                        verbose_name="restrict device types",
                    ),
                ),
                (
                    "restrict_site_types",
                    models.BooleanField(
                        ...
                        default=False,
                        help_text="Flag indicating whether to restrict site types associated with this sampling event type",
                        verbose_name="restrict site types",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        ...
                        db_column="metadata_schema",
                        default=irekua_database.utils.simple_JSON_schema,
                        help_text="JSON Schema for metadata of descriptors of this type",
                        null=True,
                        validators=[
                            irekua_database.utils.validate_JSON_schema
                        ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        db_column="description",
                        help_text="Description of term type",
                        verbose_name="description",
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="termsuggestion_created_by",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="creator",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="termsuggestion_modified_by",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="modified by",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        db_column="scope",
                        help_text="Scope of term. Use for disambiguation.",
                        max_length=128,
                        verbose_name="scope",
                    ),
                ),
                ...
                (
                    ...
                    models.URLField(
                        blank=True,
                        db_column="url",
                        help_text="URL for term description",
                        verbose_name="term url",
                    ),
                ),
                (
                    "metadata",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_column="synonym",
                        help_text="Suggestion of synonym",
                        max_length=128,
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        db_column="description",
                        help_text="Description of synonym",
                        verbose_name="description",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="synonymsuggestion_created_by",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="creator",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="synonymsuggestion_modified_by",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="modified by",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        db_column="source_id",
                        help_text="Reference to the source of synonym",
                        on_delete=django.db.models.deletion.CASCADE,
                ...
                (
                    ...
                    models.ForeignKey(
                        db_column="target_id",
                        help_text="Reference to the target of the synonym",
                        on_delete=django.db.models.deletion.CASCADE,
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        ...
                        db_column="metadata_schema",
                        default=irekua_database.utils.simple_JSON_schema,
                        help_text="JSON Schema for metadata of site info",
                        validators=[
                            irekua_database.utils.validate_JSON_schema
                        ],
                        verbose_name="metadata schema",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, to="irekua_database.SiteDescriptorType"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.CASCADE,
                        to="irekua_database.SiteDescriptorType",
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        ...
                        help_text="Upload file associated to file",
                        null=True,
                        upload_to=get_secondary_item_path,
                        verbose_name="item file",
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        ...
                        db_column="metadata_schema",
                        default=irekua_database.utils.simple_JSON_schema,
                        help_text="JSON schema for metadata associated to device in sampling event",
                        validators=[
                            irekua_database.utils.validate_JSON_schema
                        ],
                        verbose_name="metadata schema",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        help_text="Type of device that can be used in sampling event of the given type",
                        on_delete=django.db.models.deletion.PROTECT,
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        help_text="Sampling event type in which this device types can be placed",
                        on_delete=django.db.models.deletion.CASCADE,
                        to="irekua_database.SamplingEventType",
                        verbose_name="sampling event type",
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                help_text="Valid device types for this sampling event type",
                through="irekua_database.SamplingEventTypeDeviceType",
                to="irekua_database.DeviceType",
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        help_text="Date at which the device started capturing information.",
                        null=True,
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        help_text="Date at which the device stoped capturing information.",
                        null=True,
                        verbose_name="recovered on",
                    ),
                ),
                (
                    "commentaries",
                ...
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        ...
                        db_column="metadata",
                        default=irekua_database.utils.empty_JSON,
                        help_text="Metadata associated to sampling event device",
                        null=True,
                        verbose_name="metadata",
                    ),
                ),
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        ...
                        default=irekua_database.utils.empty_JSON,
                        help_text="Configuration on device through the sampling event",
                        null=True,
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        help_text="Reference to collection device used on sampling event",
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        to="irekua_database.CollectionDevice",
                        verbose_name="collection device",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="samplingeventdevice_created_by",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="creator",
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="samplingeventdevice_modified_by",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="modified by",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        help_text="Sampling event in which this device was deployed",
                        on_delete=django.db.models.deletion.PROTECT,
                        to="irekua_database.SamplingEvent",
                        verbose_name="sampling event",
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                help_text="Type of sampling event",
                on_delete=django.db.models.deletion.PROTECT,
                to="irekua_database.SamplingEventType",
                verbose_name="sampling event type",
            ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="Permissions associated to role",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_column="name",
                        help_text="Name of meta collection",
                        max_length=64,
                        unique=True,
                        verbose_name="name",
                    ),
                ...
                (
                    ...
                    models.TextField(
                        db_column="description",
                        help_text="Description of Meta Collection",
                        verbose_name="description",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="Curators of metacollection",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="Items belonging to MetaCollection",
                        to="irekua_database.Item",
                        verbose_name="items",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="metacollection_modified_by",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="modified by",
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.PROTECT,
                to="irekua_database.LocalityType",
                verbose_name="locality type",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                on_delete=django.db.models.deletion.PROTECT,
                to="irekua_database.LicenceType",
                verbose_name="licence type",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                help_text="Sampling event device used to create item",
                on_delete=django.db.models.deletion.PROTECT,
                to="irekua_database.SamplingEventDevice",
                verbose_name="sampling event device",
            ),
        ),
        migrations.AddField(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        help_text="Subdependency at institution",
                        max_length=256,
                        null=True,
                ...
                (
                    ...
                    models.CharField(
                        ...
                        db_column="country",
                        help_text="Country home of institution",
                        max_length=2,
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        db_column="address",
                        help_text="Address of institution",
                ...
                (
                    ...
                    models.URLField(
                        blank=True,
                        db_column="website",
                        help_text="Website of institution",
                        verbose_name="website",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="institution_created_by",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="creator",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="institution_modified_by",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="modified by",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        blank=True,
                        db_column="metadata",
                        help_text="Metadata associated to entailment",
                        null=True,
                        verbose_name="metadata",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        db_column="source_id",
                        help_text="Source of entailment",
                        on_delete=django.db.models.deletion.CASCADE,
                ...
                (
                    ...
                    models.ForeignKey(
                        db_column="target_id",
                        help_text="Target of entailment",
                        on_delete=django.db.models.deletion.CASCADE,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="irekua_database.DeviceBrand",
                verbose_name="brand",
            ),
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        db_column="collection_id",
                        help_text="Collection to which user belongs",
                        on_delete=django.db.models.deletion.CASCADE,
                        to="irekua_database.Collection",
                        verbose_name="collection",
                    ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="collectionuser_created_by",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="creator",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="collectionuser_modified_by",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="modified by",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        db_column="role_id",
                        help_text="Role of user in collection",
                        on_delete=django.db.models.deletion.PROTECT,
                        to="irekua_database.Role",
                        verbose_name="role",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_column="name",
                        help_text="Name of collection type",
                        max_length=128,
                        unique=True,
                        verbose_name="name",
                    ),
                ...
                (
                    ...
                    models.TextField(
                        db_column="description",
                        help_text="Description of collection type",
                        verbose_name="description",
                    ),
                ),
                (
                    ...
                    models.ImageField(
                        blank=True,
                        db_column="logo",
                        help_text="Logo of collection type",
                        null=True,
                ...
                (
                    ...
                    django.contrib.postgres.fields.jsonb.JSONField(
                        ...
                        db_column="metadata_schema",
                        default=irekua_database.utils.simple_JSON_schema,
                        help_text="JSON Schema for metadata of collection info",
                        validators=[
                            irekua_database.utils.validate_JSON_schema
                        ],
                        verbose_name="metadata schema",
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        default=False,
                        help_text="Boolean flag indicating wheter any user can create collections of this type",
                        verbose_name="anyone can create",
                    ),
                ),
                (
                    "restrict_site_types",
                    models.BooleanField(
                        ...
                        db_column="restrict_site_types",
                        default=True,
                        help_text="Flag indicating whether types of sites are restricted to registered ones",
                        verbose_name="restrict site types",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        ...
                        default=True,
                        help_text="Flag indicating whether types of annotations are restricted to registered ones",
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        default=True,
                        help_text="Flag indicating whether types of items are restricted to registered ones",
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        default=True,
                        help_text="Flag indicating whether types of licences are restricted to registered ones",
                        verbose_name="restrict licence types",
                    ),
                ),
                (
                    "restrict_device_types",
                    models.BooleanField(
                        ...
                        db_column="restrict_device_types",
                        default=True,
                        help_text="Flag indicating whether types of devices are restricted to registered ones",
                        verbose_name="restrict device types",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        ...
                        default=True,
                        help_text="Flag indicating whether types of events are restricted to registered ones",
                        verbose_name="restrict event types",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        ...
                        default=True,
                        help_text="Flag indicating whether types of sampling events are restricted to registered ones",
                        verbose_name="restrict sampling event types",
                    ),
                ),
                (
                    "administrators",
                    models.ManyToManyField(
                        blank=True,
                        help_text="Administrators of this collection type. Administrators can create collections of this type",
                        to=settings.AUTH_USER_MODEL,
                        verbose_name="administrators",
                    ),
                ),
                (
                    ...
                    models.ManyToManyField(
                        ...
                        to="irekua_database.AnnotationType",
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        through="irekua_database.CollectionDeviceType",
                        to="irekua_database.DeviceType",
                        verbose_name="device types",
                    ),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="Types of items valid for collections of type",
                        through="irekua_database.CollectionItemType",
                        to="irekua_database.ItemType",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="Roles valid for collections of type",
                        through="irekua_database.CollectionRole",
                        to="irekua_database.Role",
                        verbose_name="roles",
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                db_column="site_id",
                help_text="Reference to Site",
                on_delete=django.db.models.deletion.PROTECT,
                to="irekua_database.Site",
                verbose_name="site",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, to="irekua_database.SiteDescriptor"
            ),
        ),
        migrations.AddField(
            model_name="collectionsite",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                help_text="Collection type in which role applies",
                on_delete=django.db.models.deletion.CASCADE,
                to="irekua_database.CollectionType",
                verbose_name="collection type",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ForeignKey(
                db_column="role_id",
                help_text="Role to be part of collection",
                on_delete=django.db.models.deletion.PROTECT,
                to="irekua_database.Role",
                verbose_name="role",
            ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                db_column="item_type_id",
                help_text="Item to be part of collection",
                on_delete=django.db.models.deletion.PROTECT,
                to="irekua_database.ItemType",
                verbose_name="item type",
            ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                help_text="Reference to physical device",
                on_delete=django.db.models.deletion.PROTECT,
                to="irekua_database.PhysicalDevice",
                verbose_name="physical device",
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                help_text="Institution to which the collection belogs",
                null=True,
                on_delete=django.db.models.deletion.PROTECT,
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                through="irekua_database.CollectionDevice",
                to="irekua_database.PhysicalDevice",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                through="irekua_database.CollectionSite",
                to="irekua_database.Site",
            ),
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="irekua_database.CollectionUser",
                to=settings.AUTH_USER_MODEL,
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True,
                db_column="institution_id",
                help_text="Institution to which user belongs",
                null=True,
                on_delete=django.db.models.deletion.PROTECT,
                to="irekua_database.Institution",
                verbose_name="institution",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        help_text="Term type of source of entailment",
                        on_delete=django.db.models.deletion.CASCADE,
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        help_text="Term type of target of entailment",
                        on_delete=django.db.models.deletion.CASCADE,
